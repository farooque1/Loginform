        ...
        <div class="container">          
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="index.php">PRODUCTS</a>
              </li>  
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#brand">ABOUT US</a>
              </li> 
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#Gallery">Gallery</a>
              </li> 
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#contact">Login/SginUp</a>
              </li>
              <li>
                <?php
